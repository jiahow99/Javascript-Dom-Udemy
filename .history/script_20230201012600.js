...
nav.mouseover(function (e) { 
  const link = $(e.target);
  // link.closest('.nav__item').siblings().animate({opacity: 0.5},200);
  // link.closest('.nav__item').siblings().css('opacity', '0.5');
  link.addClass('active');
  $('.nav__item').not('.btn-open-acc, .active').css('opacity', '0.5');
  // link.not('.btn-open-acc').css('opacity', '0.5');
});

// $.each($('.nav__item'), function () { 
//   //  console.log($(this).not('.btn-open-acc'));
//   // if ($(this).not($('.btn-open-acc'))) {
//     // console.log('123');
//   }
  // console.log('1');
// });

console.log($('.nav__item').not('.btn-open-acc'));

nav.mouseout(function (e) { 
  const link = $(e.target);
  // link.closest('.nav__item').siblings().animate({opacity: 1},200);
});
